...
namespace ElibraryManagaement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        {
            if (checkIfBookExiste())
            {
                Response.Write("<script>alert('Book Already Existe.');</script>");
            }
            else
            {
                addNewBook();
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name," +
                    "genre,author_name,publisher_name,publish_date,language," +
                    "edition,book_cost,no_of_pages,book_description,actual_stock,current_stock," +
                    "book_img_link) values(@book_id,@book_name,@genre,@author_name," +
