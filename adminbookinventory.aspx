<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="ElibraryManagaement.adminbookinventory" %>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList1" 
                                        ...
                                        <asp:ListItem Text="Urdu" Value="Urdo" />
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList3" 
                                        runat="server">
                                        <asp:ListItem Text="Place 1" Value="Place 1" />
                                        <asp:ListItem Text="Place 2" Value="Place 2" />
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:ListBox class="form-control" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="5">
                                        ...
                                        <asp:ListItem Text="Romanve" Value="Romanve" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox7"
                                        runat="server" placeholder="Issued Stock" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
